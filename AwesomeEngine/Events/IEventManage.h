...
namespace AwesomeEngine
{
	...
	public:
		...
		virtual bool VAddListener(const SimpleFunctionDelegate& eventDelegate, const EventType& type) = 0;

		// Removes a delegate/event type pairing from the internal
		// tables.Returns false if the pairing was not found.
		virtual bool VRemoveListener(const SimpleFunctionDelegate& eventDelegate, const EventType& type) = 0;
		...
		virtual bool VTriggerVTriggerEvent(const IEventDataPtr& pEvent) const = 0;
